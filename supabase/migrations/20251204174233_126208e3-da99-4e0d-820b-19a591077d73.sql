...
-- 1. Fix update_merchant_coordinates - add search_path
CREATE OR REPLACE FUNCTION public.update_merchant_coordinates(merchant_id integer, latitude numeric, longitude numeric)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
-- 2. Fix auto_geocode_merchant - add search_path
