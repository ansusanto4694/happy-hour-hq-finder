...
const RestaurantsSitemap = () => {
  ...
  useEffect(() => {
    const fetchSitemap = async () => {
      try {
        console.log('Fetching restaurants sitemap from edge function...');
        ...
        if (error) {
          console.error('Error fetching restaurants sitemap:', error);
        ...
        console.error('Error fetching restaurants sitemap:', err);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading restaurants sitemap...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-destructive mb-2">Error loading restaurants sitemap</p>
...
export default RestaurantsSitemap;
