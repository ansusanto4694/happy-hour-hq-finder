              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-1">
                  {hasActiveOffers && (
                    <Badge 
                      variant="default" 
                      className="flex-shrink-0 text-xs px-1 py-0 font-medium bg-green-600 hover:bg-green-700"
                    >
                      Offer Available
                    </Badge>
                  )}
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex flex-col gap-2">
                  {hasActiveOffers && (
                    <Badge 
                      variant="default" 
                      className="flex-shrink-0 text-xs px-1 py-0 bg-green-600 hover:bg-green-700"
                    >
                      Offer Available
                    </Badge>
                  )}
